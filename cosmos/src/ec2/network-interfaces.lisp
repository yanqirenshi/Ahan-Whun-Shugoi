...
(defvar *columns_ec2_network-interfaces*
  '((:code :|TagSet|             :slot TagSet             :set-value set-value-simple)
    ...
    ;; ignore
    (:code :|Association|        :slot nil                :set-value set-value-ignore :node :association)
    (:code :|Attachment|         :slot nil                :set-value set-value-ignore :node :attachment)
    (:code :|PrivateIpAddresses| :slot nil                :set-value set-value-ignore :node :???)))
