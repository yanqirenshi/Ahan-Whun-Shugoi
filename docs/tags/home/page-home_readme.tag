<page-home_readme>
    ...
    <section class="section" style="padding-top: 0px; padding-bottom: 0px;">
        <div class="container">
            ...
            <h2 class="subtitle">AWS Cli ラッパー、 マニュアルを添えて。</h2>
            <div class="contents">
                <p>AWS Cli を Common Lisp 上から、なるだけ安全に実行するためのライブラリです。</p>
                <p>コマンドでのパラメータの値の型チェック、実行制限が出来ます。</p>
            </div>
    </section>
    ...
    <section class="section">
        <div class="container">
            <div class="contents">
                ...
                <p>Copyright (c) 2015 Satoshi Iwasaki (yanqirenshi@gmail.com)</p>
            </div>
        </div>
    </section>
