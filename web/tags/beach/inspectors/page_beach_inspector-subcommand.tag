<page_beach_inspector-subcommand>
    <div class="flex-parent">
        ...
        <div class="flex-item" style="flex-grow: 1; overflow: auto;">
            <page_beach_inspector-subcommand-basic class="hide"></page_beach_inspector-subcommand-basic>
            <page_beach_inspector-subcommand-options
                class="hide"
                options={getOptions()}
                callback={callbackDisplayController}></page_beach_inspector-subcommand-options>
            <page_beach_inspector-subcommand-manual class="hide"></page_beach_inspector-subcommand-manual>
        </div>
    </div>
